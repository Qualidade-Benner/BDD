...
Quero que ao fizer a devolução de PEGs/Guias
Esperado que a tela permaneca aberta permitindo a impressão do motivo de devolução

Cenário: Verificar devolução de PEGs em fase de Digitação
#[Processamento de contas] > Competências de PEG > Filial > Em Digitação
